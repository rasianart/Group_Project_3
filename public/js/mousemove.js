$(document).ready(function() {
    ...
    $('.abs').on('mouseenter', function() {
        if (!toggle) {
            ...
            $(this).children('.visor').css({'width': '1400px', 'height': '23px', 'width': '1400px', 'opacity': '1', 'background-color': '#d1d1d1'});
    ...
    $('.abs').on('mouseleave', function() {
        if (!toggle) {
            ...
            $(this).children('.visor').css({'height': '30px', 'width': '70px', 'opacity': '0', 'background-color': '#d1d1d1'});
